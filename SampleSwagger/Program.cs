...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "SampleSwagger", Version = "v1" });
...
var appSettingsSection = builder.Configuration.GetSection("JwtOptions");
builder.Services.Configure<JwtOptions>(appSettingsSection);
